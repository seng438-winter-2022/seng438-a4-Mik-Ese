...
The report summary generated by PiTest of the provided tests for section 2.5.3, located on `jfreechart-1.0.19\tests\org\jfree\data`, can be found [here](https://github.com/seng438-winter-2022/seng438-a4-Mik-Ese/blob/main/ProvidedTestsMutationTestResults.zip). In addition, our initial and final mutation scores can be found here for [initial](https://github.com/seng438-winter-2022/seng438-a4-Mik-Ese/blob/main/InitialMutationTestResults.zip) and here for [final](https://github.com/seng438-winter-2022/seng438-a4-Mik-Ese/blob/main/FinalMutationTestResults.zip).
...
Search: Uses different search results, such as headphones, phones and empty search queries
